...
public class MeetingroomService {
    ...
    public MeetingroomDto save(MeetingroomDto dto) {
        Meetingroom entity = dao.save(new Meetingroom(dto.getId(), dto.getTitle(), dto.getStartDate(), dto.getEndDate(), dto.getRoomId()));
        return new MeetingroomDto(entity.getId(), entity.getTitle(), entity.getStartDate(), entity.getEndDate(),entity.getRoomId());
    }
    ...
    public ArrayList<MeetingroomDto> getAll(){
        ...
        for(Meetingroom entity:s) {
            list.add(new MeetingroomDto(entity.getId(), entity.getTitle(), entity.getStartDate(), entity.getEndDate(),entity.getRoomId()));
        }
        return list;
    }
